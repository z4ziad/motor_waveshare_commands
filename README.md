...
If you are testing the motors on the Jetson, you do NOT need to unplug the USB cabe connecting it the ESP32:  
* On the Jetson running Linux, the USB port is usually `/dev/ttyACM0`  

If you want to test motors on other OSes, you need to bypass the Jetson Orin Nano. Unplus the USB cable going the ESP32 from Jetson side and plug it into the USB port on computer running MacOS or Windows:  
